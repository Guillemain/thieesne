...
e_1 = 0.25+0.75*rand;					% Excentricite
...
% Trace de la premiere ellipse (trait noir) :
...
y_1 = P_1(2,:);
h = zeros(1,3);
h(1) = plot([x_1 x_1(1)],[y_1 y_1(1)],'k-','LineWidth',2);
set(gca,'FontSize',20);
...
e_2 = 0.25+0.75*rand;					% Excentricite
...
x_2 = P_2(1,:);
y_2 = P_2(2,:);
h(2) = plot([x_2 x_2(1)],[y_2 y_2(1)],'k-','LineWidth',2);
